...
{
    [Route("[controller]")]
    public class ResPickerController : Controller
    {
        Random r = new Random();
        int resPicked = 0;
        [HttpGet]
        ...
        {
            string result = "Please input one of the following; european, american, asian, latin";
            ...
            if(foodType == "euro" || foodType == "european")
            {
